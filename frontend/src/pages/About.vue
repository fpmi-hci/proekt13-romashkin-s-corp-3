    ...
    <section class="about-section">
        ...
        <div class="row">
            <div class="about-content">
                <img height="500" width="500" src="../assets/images/taco-chefcartoon.jpg" alt="">
                <div class="about-content-text">
                    <p>Our restaurant Romashkin's Kebab❤ was founded by Vladimir (a 6 Michelin stars chef)
                        in 2020 in Minsk. 
                        After that, thanks to the support of our customers, our brand has been popularized globally in markets
                        such as Australia, USA, Canada, UK, France, ... Mexican-style meals,
                        the products that we deliver to customers are always the best quality products.</p>
