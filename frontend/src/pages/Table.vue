    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>+375 (00) 000-00-00</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-3.png" alt="">
                <h3>Minsk. Nezalezhasti strit, pr 4, flour 5 room 505</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                <div class="input-box">
                    <label for="uCard">your card</label>
            ...
            <div class="row">
                ...
                <div class="input-box">
                    <iframe class="map"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2351.1242113807434!2d27.544813915846!3d53.89399618009747!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46dbcfe79c5d5f91%3A0x4a6f20abe71d30b!2z0JPQu9Cw0LLQvdGL0Lkg0JrQvtGA0L_Rg9GBINCR0JPQow!5e0!3m2!1sru!2sby!4v1671732147043!5m2!1sru!2sby"
                        loading="lazy"></iframe>
                </div>
            </div>
