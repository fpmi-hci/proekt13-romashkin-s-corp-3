    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <p>We guarantee to use fresh food with the best quality. Customers will enjoy <b>Doner Kebab</b>
                    with a lot of Mexican cuisine with explosive, sophisticated flavors.</p>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
            <div class="image">
                <img src="../assets/images/kebab.png" alt="" class="home-img">
            </div>
        </div>
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <p>Food to customers is always guaranteed of the best quality. Our dishes are made by chef Gordon, 
